...
const PropertyDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	if (getPropertyLoading) {
		return (
			<Stack sx={{ display: 'flex', justifyContent: 'cenetr', alignItems: 'center', width: '100%', height: '1080px' }}>
									...
									<Stack className="buttons">
										...
										<Stack className="button-box">
											{property?.meLiked && property?.meLiked[0]?.myFavorite ? (
												<FavoriteIcon style={{ color: ' #217cc7' }} fontSize={'medium'} />
											) : (
												<FavoriteBorderIcon
													fontSize={'medium'}
													// @ts-ignore
						...
						<Stack className={'property-desc-config'}>
							<Stack className={'left-config'}>
								<Stack className={'options-config'}>
									...
									{property?.propertyType === 'HISTORICAL' && (
										<Stack className={'type-options'}>
											<Stack className={'option'}>
												<Stack className={'svg-box'}>
													<img src={'/img/icons/card/wifi.svg'} />
												</Stack>
												<Stack className={'option-includes'}>
													<Typography className={'title'}>Wifi</Typography>
												</Stack>
											</Stack>
											<Stack className={'option'}>
												<Stack className={'svg-box'}>
													<img src={'/img/icons/card/parking.svg'} />
												</Stack>
												<Stack className={'option-includes'}>
											...
											<Stack className={'option'}>
												<Stack className={'svg-box'}>
													<img src={'/img/icons/card/map.svg'} />
												</Stack>
												<Stack className={'option-includes'}>
									...
									{property?.propertyType === 'CULINARY' && (
										<Stack className={'type-options'}>
											...
											<Stack className={'option'}>
												<Stack className={'svg-box'}>
													<img src={'/img/icons/card/halal.svg'} />
												</Stack>
												<Stack className={'option-includes'}>
													<Typography className={'title'}>Halal</Typography>
												</Stack>
											</Stack>
											<Stack className={'option'}>
												<Stack className={'svg-box'}>
								...
								<Stack className={'address-config'}>
									...
									<Stack className={'map-box'}>
										<iframe
											src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d385396.32111926924!2d28.682524232669916!3d41.00537020614934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa7040068086b%3A0xe1ccfe98bc01b0d0!2zSXN0YW5idWwsIMSwc3RhbmJ1bCwgVMO8cmtpeWU!5e0!3m2!1sen!2skr!4v1760974296316!5m2!1sen!2skr"
											width="100%"
											height="100%"
											style={{ border: 0 }}
							...
							<Stack className={'right-config'}>
								...
								<Stack className={'info-box'}>
									...
									<input type={'text'} placeholder={'imeldor@gmail.com'} />
								</Stack>
								<Stack className={'info-box'}>
									<Typography className={'sub-title'}>Message</Typography>
									<textarea placeholder={'Hi, I’m interested in this [Hotel/Historical/Culinary] property.'}></textarea>
								</Stack>
								<Stack className={'info-box'}>
